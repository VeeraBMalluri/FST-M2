...
public class Actvity3 {
    ...
    {	
    	Object[][] testData = new Object[][] { { 45890, "Riley", "alive" }, { 45891, "Hansel", "alive" } };
    ...
    public void addPets() {
        String reqBody = "{\"id\": 45890, \"name\": \"Riley\", \"status\": \"alive\"}";
        
        Response response = given().spec(requestSpec) 
                				   .body(reqBody) 
                				   .when().post(); 

        reqBody = "{\"id\": 45891, \"name\": \"Hansel\", \"status\": \"alive\"}";
